      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-card rounded-3xl p-8 md:p-12 shadow-artistic mb-12"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {contactInfo.map((contact, index) => (
                <motion.a
                  ...
                  className="flex flex-col items-center p-6 rounded-2xl bg-background/50 hover:bg-background transition-all duration-300 group"
                >
                  <div className={`w-14 h-14 rounded-xl bg-muted flex items-center justify-center mb-4 group-hover:scale-110 transition-transform ${contact.color}`}>
